    ...
    >
      <SliderPrimitive.Control className="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        <SliderPrimitive.Track
          ...
          /* `bg-edge`, not `bg-muted`: in this app `muted` is a text colour,
             and a track painted in it reads as a filled bar. */
          className="relative grow overflow-hidden rounded-full bg-edge select-none data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1"
        >
